...
export function NpmIcon() {
  return (
    <div className="fixed top-[3vw] right-[3vw] z-50 flex items-center gap-[0.2vw] max-md:top-4 max-md:right-4 max-md:gap-3">
      <Link
        href="https://github.com/briskgaurav/creative-skills-kit"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="creative-skills-kit on GitHub"
        className="text-foreground/70 opacity-100 transition-all duration-200 ease-in-out hover:text-foreground focus:text-foreground"
      >
        <span className="block size-[2vw] max-md:size-8" aria-hidden="true">
          <svg
            width="100%"
            height="100%"
            viewBox="-2 -2 24 24"
